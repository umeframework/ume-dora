...
public class FieldDescBean implements java.io.Serializable {
	...
	/**
	 * @param colPrecisionLength the colPrecisionLength to set
	 */
	...
	/**
	 * @param colMinLength the colMinLength to set
	 */
	...
	/**
	 * @param colMaxLength the colMaxLength to set
	 */
	...
	/**
	 * @param colMinByteLength the colMinByteLength to set
	 */
	...
	/**
	 * @param colMaxByteLength the colMaxByteLength to set
	 */
	...
	/**
	 * @param colConstValue the colConstValue to set
	 */
	...
	/**
	 * @param colTextFormat the colTextFormat to set
	 */
	...
	/**
	 * @param fieldAnnotationList the fieldAnnotationList to set
	 */
