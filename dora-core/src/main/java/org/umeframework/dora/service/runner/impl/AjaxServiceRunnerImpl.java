 ...
 *
 */
public class AjaxServiceRunnerImpl extends TransactionalServiceRunnerImpl implements AjaxServiceRunner {
	/**
	 ...
	 */
	@Override
	public Object executeAjax(String serviceId, String ajaxInput) throws Throwable {
		...
		return super.execute(serviceId, params);
	}
    /**
     * render
     * 
     ...
     */
	@Override
    public String render(Object outputObj) {
        String ajaxOutput = ajaxRender.render(outputObj);
        return ajaxOutput;
    }
